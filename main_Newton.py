...
from polynomial_Newton_2d import *

def polynomial_Newton_interpolation(x, y, num=100):
    polynomial2d = polynomial_Newton_2d(x, y)
...
if __name__ == '__main__':
    ...
    def on_click(event):
        ...
        if len(x_points) > 1 and len(x_points) == len(y_points):
            x_curve_points, y_curve_points = polynomial_Newton_interpolation(x_points, y_points, num=500)
